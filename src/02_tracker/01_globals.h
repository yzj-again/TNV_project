...
// 配置信息
extern char *cfg_appids;              // 应用ID表，应用限制
extern char *cfg_maddrs;              // MySQL地址表
extern char *cfg_raddrs;              // Rdedis地址表
...
extern int cfg_ktimeout;              // Redis键超时 创建键值对要在b+树
...
// 上面是只读，下面是可读可写
extern std::map<std::string, std::list<storage_info_t>> g_groups;
