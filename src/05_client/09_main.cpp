...
{
    // ./client 127.0.0.1:21000;xxxx groups
    // ./client 127.0.0.1:21000;xxxx upload tnvideo tnv001 ~/videos/001.mp4
    // ./client 127.0.0.1:21000;xxxx filesize tnvideo  tnv001 16ABF...DEF
    // ./client 127.0.0.1:21000;xxxx download tnvideo  tnv001 16ABF...DEF 0 1024或0(全部下载)
    // ./client 127.0.0.1:21000;xxxx delete tnvideo  tnv001 16ABF...DEF
...
int main(int argc, char *argv[])
{
    ...
    char const *taddrs = argv[1]; // 地址
    char const *subcmd = argv[2]; // 子命令
    // 初始化ACL库
    acl::acl_cpp_init();
